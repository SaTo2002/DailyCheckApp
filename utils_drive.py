...
def upload_pdf_to_drive(pdf_path, year_str, month_str, area_name):
    ...
    try:
        ...
        print(f"[Drive] Successfully uploaded: {file_name} (ID: {uploaded_file.get('id')})")
        return True
    except Exception as e:
